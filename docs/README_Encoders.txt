...
See platform_config.pdf for the additional numbers you need (encoder counts per revolution, wheel radius) to compute the distance travelled by the wheel given the encoder counts (ie: to compute the "X meters travelled" above).
